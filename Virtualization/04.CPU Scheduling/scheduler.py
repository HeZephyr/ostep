...
if __name__ == "__main__":
    ...
    if options.solve == True:
        ...
        if options.policy == 'RR':
            print('Execution trace:')
            # Store the turnaround time for each job
            turnaround = {}
            # Store the response time for each job
            response = {}
            # last run time
            lastran = {}
            wait = {}
        ...
        # If the -c option is not passed, the user is prompted to calculate the job's turnaround time, response time, and wait time
